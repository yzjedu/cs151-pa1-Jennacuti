...
- There is no reason to use while true in this code
- There is no reason to use functions in this code. 
- There are no comments, and this code looks very advanced for your skills. 
- If you can convince me that you have written this code, then I can amend your grade. 
### PA Grade: N
